...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="StRegister.css">
    <title>form</title>
</head>
...
move_uploaded_file($tempname,$folder);
    ...
    if($fname !="" && $PIN !="" && $pwd !="" && $gender !="" && $email !="" && $phone !="" &&  $caste !="" &&  $lang1 !="" && $address !="")
    {

  $query = "INSERT INTO form(std_image,fname,PIN,password,cppassword,gender,email,phone,caste,language,address)
   values('$folder','$fname','$PIN','$pwd','$cpwd','$gender','$email','$phone','$caste','$lang1','$address')";
